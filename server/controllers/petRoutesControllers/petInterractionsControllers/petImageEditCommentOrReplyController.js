...
import { petEditImageCommentValidation } from "../../../utils/bodyValidation/pets/petImageCommentsValidationSchemas.js";
...
const petImageEditCommentOrReplyController = async ( req, res ) => {
    try{
        ...
        if( image ){
            ...
            const commentObject = image.comments
                                       .find(
                                            comment =>
            ...
            if( isReply ){
                const replyObject = commentObject.replies
                                                 .find(
                                                    reply =>
                                                        reply._id
                                                             .toString() === req.body
                ...
                commentObject.comment = req.body
                                           .newComment;
            }
