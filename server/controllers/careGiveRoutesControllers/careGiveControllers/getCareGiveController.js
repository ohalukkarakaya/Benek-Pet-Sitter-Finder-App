...
const getCareGiveController = async ( req, res ) => {
    try{
        ...
        var careGive = await CareGive.findById( careGiveId ).lean();
        if( !careGive ){
        ...
        if(
            userId !== careGive.careGiver.careGiverId.toString()
            && userId !== careGive.petOwner.petOwnerId.toString()
        ){
        ...
        const careGiveData = careGiveInfo;
