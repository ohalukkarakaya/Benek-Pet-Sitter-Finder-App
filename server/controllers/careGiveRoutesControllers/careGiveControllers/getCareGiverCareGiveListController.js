...
const getCareGiverCareGiveListController = async ( req, res ) => {
    try{
                  ...
                  .json(
                        {
                            ...
                            careGiveList: carGiveList,
                        }
                   );
    }catch( err ){
        console.log( "ERROR: getCareGiverCareGiveListController - ", err );
        res.status( 500 )
           .json(
                {
                    error: true,
...
export default getCareGiverCareGiveListController;