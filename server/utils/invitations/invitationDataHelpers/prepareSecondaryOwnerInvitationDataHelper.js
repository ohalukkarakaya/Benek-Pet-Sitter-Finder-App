...
const prepareSecondaryOwnerInvitationDataHelper = async ( invitation ) => {
    try{
        ...
        invitation.type = "SecondaryOwnerInvitation";
        ...
        console.log( "ERROR: prepareSecondaryOwnerInvitationDataHelper - ", err );
        return {
            error: true,
...
export default prepareSecondaryOwnerInvitationDataHelper;