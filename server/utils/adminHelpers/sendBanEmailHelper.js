...
// helpers
import careGiverBanEmailHtmlHelper from "./careGiverBanEmailHtmlHelper.js";

dotenv.config();

const sendBanEmailHelper = async ( baningUsersEmail, banDesc ) => {
    try{
        //send email
        ...
        console.log( "ERROR: sendBanEmailHelper - ", err );
        return {
            error: true,
            statusCode: 500,
...
export default sendBanEmailHelper;