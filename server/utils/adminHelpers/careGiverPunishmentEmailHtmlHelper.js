const careGiverPunishmentEmailHtmlHelper = ( punishmentDesc ) => {
    return `
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0" style="font-family: arial, helvetica, sans-serif;">
                ...
                <tr>
                    ...
                    <div style="line-height: 140%; text-align: left; overflow-wrap: break-word;">
                        ...
                        <span>
                            <strong>
                                <span style="font-size: 24px; line-height: 33.6px;">Bir Ceza Puanı Aldınız</span>
                            </strong>
                        </span>
                    </p>
                    </div>
...
export default careGiverPunishmentEmailHtmlHelper;