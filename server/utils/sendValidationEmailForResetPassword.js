...
let transporter = nodemailer.createTransport(
 ...
 const sendOTPVerificationEmailForResetPassword = async ({_id, email}, res, next) => {
    try {
      ...
      const newOtpVerification = await new ChangeEmailOTP({
        userId: _id.toString(),
        newEmail: email,
        otp: hashedOtp,
      });
  ...
  export default sendOTPVerificationEmailForResetPassword;