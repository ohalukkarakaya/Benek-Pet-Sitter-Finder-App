...
const mokaDeleteCard = async ( cardToken ) => {
    return new Promise(
        async (
            resolve,
            reject
            ...
            const config = {
                ...
                url: `${ env.MOKA_TEST_URL_BASE }/DealerCustomer/RemoveCard`,
            ...
            try{
                ...
                console.log( "ERROR: mokaDeleteCard - ", err );
                reject(
                    {
                        error: true,
                        serverStatus: -1,
