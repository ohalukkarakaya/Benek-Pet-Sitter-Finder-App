const invoiceEmailHtmlHelper = () => {
    ...
    <div class="x_u-row-container" style="padding: 0px; background-color: transparent !important;"><div class="x_u-row" style="margin: 0px auto; min-width: 320px; max-width: 500px; overflow-wrap: break-word; word-break: break-word; background-color: transparent !important;">
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0" style="font-family: arial, helvetica, sans-serif; color: rgb(255, 255, 255) !important;">
                    ...
                    <tr style="color: rgb(255, 255, 255) !important;">
                        ...
                        <div style="color: rgb(255, 255, 255) !important; line-height: 140%; text-align: left; overflow-wrap: break-word;">
                            <p style="font-size:14px; line-height:140%; text-align:center">
                            <span style="font-size: 14px; line-height: 19.6px; color: rgb(173, 173, 173) !important; font-family: Source Sans Pro, sans-serif;" data-ogsc="rgb(103, 103, 103)">Bizi tercih ettiğiniz için &nbsp; ♥︎ <b>Teşekkür Ederiz!</b></span>
                            </p>
                        </div>
                        </td>
                    </tr>
