...
class UserInfoByUserIdApi {

  final ApiClient apiClient;

  UserInfoByUserIdApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<dynamic> getUserInfoByUserIdRequest(String userId) async {
    try{
      ...
      String path = '/api/user/getUserById/$userId';
      ...
      if (response.statusCode >= 400) {
        ...
        log('ERROR: getUserInfoByUserIdRequest - response body is null');
        // await AuthUtils.killUserSessionAndRestartApp( store );
      }
    }catch( err ){
      log('ERROR: getUserInfoByUserIdRequest - $err');
      // await AuthUtils.killUserSessionAndRestartApp( store );
    }
  }
}