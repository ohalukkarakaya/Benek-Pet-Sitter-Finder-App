...
import 'package:benek/presentation/shared/components/home_screen_components/home_screen_profile_tab/care_give_career_preview_widget/care_give_list_element.dart';
import 'package:flutter/material.dart';

import '../../../../../../../common/utils/benek_string_helpers.dart';
import 'care_give_detail_widget.dart';
...
class _CareGivePreviewWidgetState extends State<CareGivePreviewWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        if (widget.careGiveList == null || widget.careGiveList!.isEmpty) {
          return;
        }
        ...
        Navigator.push(
          ...
          PageRouteBuilder(
            ...
            pageBuilder: (context, _, __) => const CareGiveDetailWidget(),
          ),
        );
      },
      child: MouseRegion(
        cursor: widget.careGiveList != null && widget.careGiveList!.isNotEmpty
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    height: 145,
                    child: widget.careGiveList != null && widget.careGiveList!.isNotEmpty
                        ? ListView.builder(
                            shrinkWrap: true,
                            physics: const NeverScrollableScrollPhysics(),
                            itemCount: widget.careGiveList!.length <= 3 ? widget.careGiveList!.length : 3,
                            itemBuilder: (context, index) {
                              int itemCount = widget.careGiveList!.length <= 3 ? widget.careGiveList!.length : 3;
                              return Column(
                                children: [
                                  SizedBox(
                                    height: 38,
                                    child: widget.careGiveList![index].pet is String
                                        ? const CareGiveLoadingWidget()
                                        : CareGiveListElement(careGiveInfo: widget.careGiveList![index]),
                                  ),
                                  if (index < itemCount - 1)
                                    Divider(
                                      color: widget.careGiveList![index].pet is String ? AppColors.benekBlack : AppColors.benekWhite,
                                      thickness: 0.5,
                                    ),
                                ],
                              );
